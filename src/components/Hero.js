...
function Hero() {
  ...
  return (
    <div className="bg-discord_blue pb-8 md:pb-0">
      <div className="p-7 py-9 h-screen md:h-[91.2vh] md:flex relative">
        ...
        <div className="flex-grow">
          <img
            src="https://cine-production.github.io/ServiceTiers/BASEDONNEE/FC/1.svg"
            alt=""
            className="fixed -left-36 mt-16 sm:-left-44 md:hidden"
          />
          <img
            src="https://cine-production.github.io/ServiceTiers/BASEDONNEE/FC/2.svg"
            alt=""
            className="hidden md:inline fixed"
          />
        </div>
      </div>
    </div>
